...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nama_pic = handleUpload('nama_pic');
    ...
    $query = "INSERT INTO pengumpulan (
         date, nama_pic, akreditasi, visi_misi, maklumat, sop, indeks_kepuasan,
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="add.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <!-- Left Column -->
                                <div class="col-lg-6">
                                        <label class="font-weight-bold">Nama PIC UPUBKB</label>
                                        <input type="text" name="nama_pic" class="form-control form-control-user">
                                    <?php
                                    $fields_left = [
